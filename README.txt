...
O ambiente é composto por 2 maquinas linux virtualizadas através de containers do docker. A imagem do ubuntu usada pode ser verifficada no arquivo "dockerfile" na raiz do projeto.
...
O arquivo "docker-compose" é responsável por criar os 2 containers. Eles fazer parte de uma rede e simulam a conexão externa. Isso pode ser verificado pelo comando telnet:
 ...
 - Ao usar telnet com ip da maquina e a porta 1099 a conexão obtem sucesso
